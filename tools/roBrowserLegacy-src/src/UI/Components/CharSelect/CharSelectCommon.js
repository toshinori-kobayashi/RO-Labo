		...
		if (gridLayout) {
			switch (error) {
				...
				case 4: // 4: Deleting not yet possible time.
					...
					return;
				case 5: // 5: confirmation code does not match (packet birthdate[6])
					// msgstringtable.csv overlays this id with an unrelated label ("LIMITED").
					UIManager.showMessageBox('削除確認コードが一致しません。', 'ok');
					return;
